...
class Test_Files_Sharing_Storage extends OCA\Files_sharing\Tests\TestCase {
	 ...
	 * @medium
	 */
	public function XtestParentOfMountPointIsGone() {
	 ...
	 * @medium
	 */
	public function XtestRenamePartFile() {
	...
	public function XtestGetPermissions() {
		$share = $this->share(
			\OCP\Share::SHARE_TYPE_USER,
			$this->folder,
			self::TEST_FILES_SHARING_API_USER1,
	...
	public function XtestFopenWithReadOnlyPermission() {
	...
	public function XtestFopenWithCreateOnlyPermission() {
		$this->view->file_put_contents($this->folder . '/existing.txt', 'foo');
	...
	public function XtestFopenWithUpdateOnlyPermission() {
		$this->view->file_put_contents($this->folder . '/existing.txt', 'foo');
	...
	public function XtestFopenWithDeleteOnlyPermission() {
		$this->view->file_put_contents($this->folder . '/existing.txt', 'foo');
	...
	public function XtestMountSharesOtherUser() {
	...
	public function XtestCopyFromStorage() {
		self::loginHelper(self::TEST_FILES_SHARING_API_USER1);
	...
	public function XtestMoveFromStorage() {
		self::loginHelper(self::TEST_FILES_SHARING_API_USER1);
